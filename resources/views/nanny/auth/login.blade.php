                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-9 col-lg-8 mx-auto">
                            ...
                            <form method="POST" action="{{ route('nanny.login.post') }}">
                                @csrf
                                ...
                                <div class="custom-control text-center mb-3">
                                    <a href="{{ route('nanny.register.get') }}">Don't have an account? Register now</a>
                                </div>
                                ...
                                <div class="text-center">
                                    <a class="small"
                                        href="{{ route('nanny.password.request') }}">{{ __('Forgot Your Password?') }}</a>
                                </div>
                                @endif
                            </form>
                        </div>
