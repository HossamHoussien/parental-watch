        ...
        <div class="container">
            <div class="stats d-flex justify-content-center mt-3">
                <div class="card text-white text-center bg-dark mb-3 mx-2" style="max-width: 18rem;width: 200px;">
                    <div class="card-body">
                        <h1 class="card-title">{{ $nanny->hiringCount() }}</h1>
                    </div>
                    ...
                    <li class="pending">
                        ...
                        <div>
                            <button class="btn btn-success btn-sm"
                                onclick="window.location.assign('{{ route('nanny.requests.accept', $request->id) }}')">Accpet</button>
                            <button class="btn btn-danger btn-sm"
                                onclick="window.location.assign('{{ route('nanny.requests.decline', $request->id) }}')">Decline</button>
                        </div>
                        @endif
    ...
    <div class="container mt-5 mb-5 timeline">
        <div class="row">
            <div class="col-md-6 offset-md-3">
                ...
                <ul class="timeline">
                    @foreach ($nanny->history->sortByDesc('created_at') as $history)
